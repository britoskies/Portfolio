      ...
      .then(
        (result) => {
          if (result.text === "") {
            return toast({
              title: "Error",
              description: "Hey! Please fill in all fields.",
              status: "warning",
              duration: 9000,
              isClosable: true,
            });
          ...
          toast({
            title: "Success",
            description:
              "Your message was recieved! I'll be in contact as soon as posible.",
            status: "success",
            duration: 9000,
            isClosable: true,
          });
          ...
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            ...
            >
              ...
              >
                ...
                <Link
                  href="https://github.com/britoskies"
                  target="_blank"
                  data-aos="fade-left"
                  data-aos-duration={2000}
                >
                ...
                <Link
                  href="https://www.linkedin.com/in/britoskies"
                  target="_blank"
                  data-aos="fade-left"
                  data-aos-duration={2000}
                >
                ...
                <Link
                  href="https://www.instagram.com/britoskies"
                  target="_blank"
                  data-aos="fade-left"
                  data-aos-duration={2000}
                >
